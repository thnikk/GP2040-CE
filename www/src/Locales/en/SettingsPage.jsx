export default {
	...
	'hotkey-settings-description-text': 'Assign button combinations to quickly perform actions. Enable pin mode toggle to map directly to pins instead of button actions.',
