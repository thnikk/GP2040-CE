...
#define KEYBOARD_KEYCODE_GP28 HID_KEY_ARROW_UP
#define GPIO_PIN_15 GpioAction::BUTTON_PRESS_DOWN   // DOWN   | DOWN   | DOWN    | DOWN     | DOWN   | DOWN   |
#define KEYBOARD_KEYCODE_GP15 HID_KEY_ARROW_DOWN
...
#define KEYBOARD_KEYCODE_GP14 HID_KEY_ARROW_LEFT
...
#define KEYBOARD_KEYCODE_GP04 HID_KEY_X
#define GPIO_PIN_27 GpioAction::BUTTON_PRESS_L2     // L2     | LT     | ZL      | L2       | 7      | K4     |
#define KEYBOARD_KEYCODE_GP27 HID_KEY_V
...
#define PIN_WEBCONFIG_ADVANCED 13
...
#define HOTKEY_10_PIN_TRIGGER_MASK ((1 << 6) | (1 << 9) | (1 << 12))
...
#define DEFAULT_INPUT_MODE_SWITCH_PIN 7   // B2 (GP7)
#define DEFAULT_INPUT_MODE_PS3_PIN 5      // B3 (GP5)
#define DEFAULT_INPUT_MODE_PS4_PIN 3      // B4 (GP3)
#define DEFAULT_INPUT_MODE_PS5_PIN 2      // R1 (GP2)
#define DEFAULT_INPUT_MODE_KEYBOARD_PIN 29 // L1 (GP29)
...
#define PIN_MENU_UP     28  // matches BUTTON_PRESS_UP
#define PIN_MENU_DOWN   15  // matches BUTTON_PRESS_DOWN
#define PIN_MENU_LEFT   14  // matches BUTTON_PRESS_LEFT
