...
#define GPIO_PIN_09 GpioAction::BUTTON_PRESS_L2     // B1     | A      | B       | Cross    | 2      | K1     |
#define GPIO_PIN_12 GpioAction::BUTTON_PRESS_R2     // B2     | B      | A       | Circle   | 3      | K2     |
#define GPIO_PIN_13 GpioAction::BUTTON_PRESS_B2     // R2     | RT     | ZR      | R2       | 8      | K3     |
#define GPIO_PIN_14 GpioAction::BUTTON_PRESS_B1     // L2     | LT     | ZL      | L2       | 7      | K4     |
#define GPIO_PIN_15 GpioAction::BUTTON_PRESS_L1     // B3     | X      | Y       | Square   | 1      | P1     |
#define GPIO_PIN_28 GpioAction::BUTTON_PRESS_R1     // B4     | Y      | X       | Triangle | 4      | P2     |
#define GPIO_PIN_27 GpioAction::BUTTON_PRESS_B4     // R1     | RB     | R       | R1       | 6      | P3     |
#define GPIO_PIN_26 GpioAction::BUTTON_PRESS_B3     // L1     | LB     | L       | L1       | 5      | P4     |
