...
#define INIT_UNSET_PROPERTY_BYTES(parent, property, byteArray) \
...
#endif
#ifndef DEFAULT_INPUT_MODE_SWITCH_PRO_PIN
    #define DEFAULT_INPUT_MODE_SWITCH_PRO_PIN -1
#endif
   ...
   #define DEFAULT_USB_DESC_PRODUCT "GP2040-th (Custom)"
#endif
...
void ConfigUtils::initUnsetPropertiesWithDefaults(Config& config)
{
    ...
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey01, usePinTrigger, HOTKEY_01_USE_PIN_TRIGGER);
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey01, pinTriggerMask, HOTKEY_01_PIN_TRIGGER_MASK);
    ...
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey02, usePinTrigger, HOTKEY_02_USE_PIN_TRIGGER);
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey02, pinTriggerMask, HOTKEY_02_PIN_TRIGGER_MASK);
    ...
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey03, usePinTrigger, HOTKEY_03_USE_PIN_TRIGGER);
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey03, pinTriggerMask, HOTKEY_03_PIN_TRIGGER_MASK);
    ...
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey04, usePinTrigger, HOTKEY_04_USE_PIN_TRIGGER);
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey04, pinTriggerMask, HOTKEY_04_PIN_TRIGGER_MASK);
    ...
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey05, usePinTrigger, HOTKEY_05_USE_PIN_TRIGGER);
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey05, pinTriggerMask, HOTKEY_05_PIN_TRIGGER_MASK);
    ...
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey06, usePinTrigger, HOTKEY_06_USE_PIN_TRIGGER);
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey06, pinTriggerMask, HOTKEY_06_PIN_TRIGGER_MASK);
    ...
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey07, usePinTrigger, HOTKEY_07_USE_PIN_TRIGGER);
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey07, pinTriggerMask, HOTKEY_07_PIN_TRIGGER_MASK);
    ...
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey08, usePinTrigger, HOTKEY_08_USE_PIN_TRIGGER);
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey08, pinTriggerMask, HOTKEY_08_PIN_TRIGGER_MASK);
    ...
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey09, usePinTrigger, HOTKEY_09_USE_PIN_TRIGGER);
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey09, pinTriggerMask, HOTKEY_09_PIN_TRIGGER_MASK);
    ...
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey10, usePinTrigger, HOTKEY_10_USE_PIN_TRIGGER);
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey10, pinTriggerMask, HOTKEY_10_PIN_TRIGGER_MASK);
    ...
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey11, usePinTrigger, HOTKEY_11_USE_PIN_TRIGGER);
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey11, pinTriggerMask, HOTKEY_11_PIN_TRIGGER_MASK);
    ...
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey12, usePinTrigger, HOTKEY_12_USE_PIN_TRIGGER);
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey12, pinTriggerMask, HOTKEY_12_PIN_TRIGGER_MASK);
    ...
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey13, usePinTrigger, HOTKEY_13_USE_PIN_TRIGGER);
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey13, pinTriggerMask, HOTKEY_13_PIN_TRIGGER_MASK);
    ...
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey14, usePinTrigger, HOTKEY_14_USE_PIN_TRIGGER);
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey14, pinTriggerMask, HOTKEY_14_PIN_TRIGGER_MASK);
    ...
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey15, usePinTrigger, HOTKEY_15_USE_PIN_TRIGGER);
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey15, pinTriggerMask, HOTKEY_15_PIN_TRIGGER_MASK);
    ...
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey16, usePinTrigger, HOTKEY_16_USE_PIN_TRIGGER);
    INIT_UNSET_PROPERTY(hotkeyOptions.hotkey16, pinTriggerMask, HOTKEY_16_PIN_TRIGGER_MASK);
    ...
    INIT_UNSET_PROPERTY(config.displayOptions, inputHistoryTimeout, INPUT_HISTORY_TIMEOUT);
    ...
    INIT_UNSET_PROPERTY(paramsLeft.common, startX, 0);
    ...
    INIT_UNSET_PROPERTY(paramsRight.common, startX, 0);
...
#define BOARD_LED_INDEX_GP29 -1
    ...
    INIT_UNSET_PROPERTY(config.animationOptions, staticColorNormal, 0xFFFFFFFF);
...
void ConfigUtils::load(Config& config)
{
    ...
    // keyboard mapping defaults from KEYBOARD_KEYCODE_GPxx / KEY_* macros
    // (must run after gpioMappingsMigrationCore)
    auto setKeyboardDefaults = [](GpioMappings& mappings) {
        ...
        uint32_t boardKeyboardKeycodes[NUM_BANK0_GPIOS] = {
            KEYBOARD_KEYCODE_GP00, KEYBOARD_KEYCODE_GP01, KEYBOARD_KEYCODE_GP02,
            KEYBOARD_KEYCODE_GP03, KEYBOARD_KEYCODE_GP04, KEYBOARD_KEYCODE_GP05,
            KEYBOARD_KEYCODE_GP06, KEYBOARD_KEYCODE_GP07, KEYBOARD_KEYCODE_GP08,
            KEYBOARD_KEYCODE_GP09, KEYBOARD_KEYCODE_GP10, KEYBOARD_KEYCODE_GP11,
            KEYBOARD_KEYCODE_GP12, KEYBOARD_KEYCODE_GP13, KEYBOARD_KEYCODE_GP14,
            KEYBOARD_KEYCODE_GP15, KEYBOARD_KEYCODE_GP16, KEYBOARD_KEYCODE_GP17,
            KEYBOARD_KEYCODE_GP18, KEYBOARD_KEYCODE_GP19, KEYBOARD_KEYCODE_GP20,
            KEYBOARD_KEYCODE_GP21, KEYBOARD_KEYCODE_GP22, KEYBOARD_KEYCODE_GP23,
            KEYBOARD_KEYCODE_GP24, KEYBOARD_KEYCODE_GP25, KEYBOARD_KEYCODE_GP26,
            KEYBOARD_KEYCODE_GP27, KEYBOARD_KEYCODE_GP28, KEYBOARD_KEYCODE_GP29
        };
        uint32_t boardKeyboardModifierMasks[NUM_BANK0_GPIOS] = {
            KEYBOARD_MODIFIER_GP00, KEYBOARD_MODIFIER_GP01, KEYBOARD_MODIFIER_GP02,
            KEYBOARD_MODIFIER_GP03, KEYBOARD_MODIFIER_GP04, KEYBOARD_MODIFIER_GP05,
            KEYBOARD_MODIFIER_GP06, KEYBOARD_MODIFIER_GP07, KEYBOARD_MODIFIER_GP08,
            KEYBOARD_MODIFIER_GP09, KEYBOARD_MODIFIER_GP10, KEYBOARD_MODIFIER_GP11,
            KEYBOARD_MODIFIER_GP12, KEYBOARD_MODIFIER_GP13, KEYBOARD_MODIFIER_GP14,
            KEYBOARD_MODIFIER_GP15, KEYBOARD_MODIFIER_GP16, KEYBOARD_MODIFIER_GP17,
            KEYBOARD_MODIFIER_GP18, KEYBOARD_MODIFIER_GP19, KEYBOARD_MODIFIER_GP20,
            KEYBOARD_MODIFIER_GP21, KEYBOARD_MODIFIER_GP22, KEYBOARD_MODIFIER_GP23,
            KEYBOARD_MODIFIER_GP24, KEYBOARD_MODIFIER_GP25, KEYBOARD_MODIFIER_GP26,
            KEYBOARD_MODIFIER_GP27, KEYBOARD_MODIFIER_GP28, KEYBOARD_MODIFIER_GP29
        };

        for (Pin_t pin = 0; pin < NUM_BANK0_GPIOS; pin++) {
            if (boardKeyboardKeycodes[pin] != 0) {
                mappings.keyboardKeycodes[pin] = boardKeyboardKeycodes[pin];
                mappings.keyboardModifierMasks[pin] = boardKeyboardModifierMasks[pin];
            } else {
